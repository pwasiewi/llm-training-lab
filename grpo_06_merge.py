# Merge a grpo_06 LoRA checkpoint into a standalone 16-bit model that vLLM (_test.py) can load.
...
# Usage: python grpo_06_merge.py [checkpoint-650]   (default: newest checkpoint)
...
model_path = "outputs/lora-grpo-dapo-lama"             # merged output dir (what _test.py reads)
