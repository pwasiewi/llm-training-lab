...
model_path = "outputs/lora-gemma2-5-imdb-liger"

# Load pre-trained model and tokenizer
model_name = "google/gemma-2-9b-it"

# Liger variant of lc_08: patch the Gemma-2 module classes with fused Triton
...
# not logits-memory gains. Compare against lc_08_gemma9b_imdb.py.
...
training_args = TrainingArguments(
    ...
    per_device_train_batch_size=32,  # 9B nf4 ~6 GB weights; GC on keeps activations small
    per_device_eval_batch_size=64,  # eval stores no activations for backward
    gradient_accumulation_steps=4,  # keep effective batch at 128 (was 16*8)
