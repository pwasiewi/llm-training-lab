# Merge a grpo_07 LoRA checkpoint into a standalone 16-bit model that vLLM (_test.py) can load.
...
# Usage: python grpo_07_merge.py [checkpoint-935]   (default: newest checkpoint)
...
model_path = "outputs/lora-grpo-phi4-mini"             # merged output dir (what _test.py reads)
